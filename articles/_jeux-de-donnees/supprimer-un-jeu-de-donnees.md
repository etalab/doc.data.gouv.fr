---
title: Supprimer un jeu de données ou un fichier
slug: supprimer-un-jeu-de-donnees
---

# Supprimer un jeu de données ou un fichier

Vous pouvez supprimer un jeu de données, ou l’un des fichier qui le compose, si vous êtes l’auteur du jeu de données en question, ou si vous appartenez à l’organisation qui en est à l’origine. Supprimer un jeu de données ou un fichier est irréversible.
...
La suppression d’un jeu de données dans son intégralité entraine la suppression de tous les fichiers qui le composent. La page de présentation du jeu de données en question sera également supprimée, elle ne sera plus visible.
...
La suppression d’un fichier n’entraîne pas la suppression du jeu de données dont le fichier fait partie. Pour éviter les erreurs de redirection, l’URL a laquelle le fichier supprimé était disponible reste valable même après la suppression du fichier en question. Dit autrement, un fichier supprimé est toujours accessible aux utilisateurs qui disposent de son lien direct.

### Supprimer un fichier publié en votre nom

Pour supprimer un fichier publié avec votre propre compte, à titre personnel :

1. [Connectez-vous à votre compte](https://www.data.gouv.fr/fr/login) ;
2. Rendez-vous sur [votre tableau de bord](https://www.data.gouv.fr/fr/admin/), en cliquant sur **Administration** en haut à droite de votre écran ;
3. Allez sur [la page de suivi de votre compte](https://www.data.gouv.fr/fr/admin/me/edit), en cliquant sur **Profil**, dans la colonne de gauche ;
4. Naviguez jusqu’à la section **Jeux de données** située en milieu de page ;
5. Cliquez sur le jeu de données qui contient le fichier à supprimer ;
6. Naviguez jusqu’à la section **Fichiers** située en milieu de page ;
7. Cliquez sur le fichier à supprimer ;
8. Cliquez sur le bouton **Supprimer** dans la fenêtre qui s’affiche alors en superposition sur votre écran ;
9. Validez la suppression du fichier en cliquant sur le bouton **Confirmer**.

### Supprimer un fichier publié au nom d’une organisation

Pour supprimer un fichier publié au nom d’une organisation à laquelle vous appartenez :
